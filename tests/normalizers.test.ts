...
import { jsxToHtml, markdownToHtml, normalizeInputToHtml, tsxToHtml } from "../src/dom";
...
describe("built-in normalizers", () => {
    ...
    it("converts jsx element trees to html-like output", () => {
        const html = jsxToHtml(`export default function App() { return <main><button aria-label="Save" /></main>; }`);
