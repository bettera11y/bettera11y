...
export function selectorToSourceLocation(
    ...
    return createRangeLocation(source, startOffset, endOffset, selector, sourcePath);
}

export function translateSeverity(severity: Severity, target: "eslint" | "vite" | "terminal"): number | string {
    if (target === "eslint") {
