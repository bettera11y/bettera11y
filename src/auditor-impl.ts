import type { Normalizer, RuntimeAdapter } from "./dom-shared";
import type {
    AuditDiagnostic,
    AuditInput,
...
/**
 * Constructs an auditor instance bound to the given runtime adapter (JSDOM, browser DOMParser, or custom).
 */
