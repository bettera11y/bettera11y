import { audit, recommendedPreset, toAdapterDiagnostic } from "../src";
...
export async function lintHtmlLikeSource(filePath: string, sourceText: string): Promise<EslintMessage[]> {
